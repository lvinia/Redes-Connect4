...
public class GameManager : MonoBehaviour
{
    ...
    Thread listenThread;
    int listenPort = 5050;
    string otherIp = "10.57.1.132"; // coloque o IP real
    ...
    private void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (myBoard.Result())
            {
                turnMessage.text = (playerIsRed ? "Vermelho" : "Verde") + " Ganhou!";
    ...
    void JogadaRecebida(int coluna)
    {
        ...
        columns = UnityEngine.Object.FindObjectsByType<Column>(UnityEngine.FindObjectsSortMode.None);
#else
        columns = UnityEngine.Object.FindObjectsOfType<Column>();
#endif
        ...
        if (myBoard.Result())
        {
            string vencedor = playerIsRed ? "Verde" : "Vermelho";
            turnMessage.text = vencedor + " Ganhou!";
            hasGameFinished = true;
            return;
        }
